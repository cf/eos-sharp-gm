...
namespace EosSharp.Core
{
    ...
    public class EosConfigurator
    {
        ...
        /// <summary>
        /// signature implementation to handle available keys and signing transactions. Use the MultiSignProvider with a privateKey to sign transactions inside the lib.
        /// </summary>
